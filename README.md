...
## Fig. 3
We notice that M3, M4 and M5 training can be relatively instable, with a high run-to-run variation. It can be mitigated by using a learning rate of 1e-4 instead of 5e-4 as discussed in the rebuttal stage of ICML. With that, generally we would see the training speed of M3, M4, and M5 are comparable. It generally holds true that M4 and M5 learn to navigate the maze faster than M3. 
